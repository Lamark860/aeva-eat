...
//
// TODO (release cleanup): ВРЕМЕННЫЙ ФАЙЛ. Снести после того, как все
// посетители из круга обновятся (≈2–3 мес после релиза) — тогда у них
// уже не будет старого кэширующего SW, который этот kill-switch чистит.
// Удалить: этот файл + регистрацию SW в main.js. См. ROADMAP.md.
//
